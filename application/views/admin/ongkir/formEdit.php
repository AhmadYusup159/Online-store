          ...
          <div class="col-md-6">
            <div class="card card-info">
             ...
             <form class="form-horizontal" method="post" action="<?php echo site_url('ongkir/edit'); ?>">
                <input type="hidden" name="id" value="<?php echo $ongkir->id_Ongkir; ?>">
                <div class="card-body">
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 col-form-label">Kota Tujuan</label>
                        <div class="col-sm-9">
                            <input type="text" name="tujuan" value="<?php $ongkir->tujuan; ?>" class="form-control" id="inputEmail3" placeholder="Kota Tujuan">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="ongkos" value="<?php $ongkir->ongkos; ?>" class="form-control" id="inputEmail3" placeholder="Ongkos">
                        </div>
                    </div>
                </div>
